...
```{r step 0 code}
library(readr)
dataset <- read_csv("https://tehrandav.is/psyc7014/practice_datasets/factorial_ANOVA_dataset_no_interactions.csv")
...
source("https://tehrandav.is/psyc7014/custom_functions/skew_kurtosis_z.R")
